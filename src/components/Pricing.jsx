    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-xl sm:text-lg text-gray-400 max-w-2xl mx-auto">
            {" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          ...
          {plans.map((plan, key) => (
            <div
              key={key}
              className={`relative backdrop-blur-sm bg-slate-900/50 p-6 sm:p-8 border  rounded-xl sm:rounded-2xl transition-all duration-300 overflow-visible group flex flex-col h-full
             ...
             <div className="absolute inset-0 bg-linear-to-br from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full -translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none rounded-lg" />
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  <span className="text-3xl sm:text-4xl lg:text-5xl bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-bold ">
                    ${plan.price}
                  </span>
                  <span className="text-sm sm:text-base text-gray-400 ml-1 sm:ml-2">
                    /month
                  </span>
                </div>
              </div>
              ...
              <button
                className={`w-full rounded-lg py-2.5 sm:py-3 px-4 sm:px-6 font-semibold transition-all duration-300 mt-auto hover:scale-102 curser-pointer text-sm sm:text-base
                    ${plan.mostPopular?
