      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-32">
          {features.map((feature, key) => (
            <div key={key} className={` flex flex-col gap-8 sm:gap-12 items-center lg:flex-row ${feature.imagePosition === "right"? "lg:flex-row-reverse":""}`}>
              {/* code section */}
              <div className="flex-1 w-full">
                <div className="relative group">
                  ...
                  {/* ide interface */}
                  <div className="bg-gray-950 p-3 sm:p-4 font-mono text-xs sm:text-sm  rounded-lg">
                    ...
                    <div className="flex items-center space-x-1 sm:space-x-2 mb-3 sm:mb-4">
                      ...
                      <span className="text-gray-400 text-xs sm:text-sm ml-2 sm:ml-4">{feature.title}</span>
                    </div>
                    {/* code */}
                    <div>
                        <SyntaxHighlighter 
              ...
              <div className="flex-1 w-full">
                  <div className="max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
                    ...
                    <p className="text-base text-gray-300  sm:text-lg leading-relaxed">{feature.description}</p>
                  </div>
              </div>
            </div>
          ))}
